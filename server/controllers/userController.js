...
export const  applyForJob = async(req,res)=>{
    ...
    try {
        ...
        const isAlreadyApplied = await jobApplicaton.find({jobId,userId})
...
export const getUserJobApplication = async(req,res)=>{
    ...
    try {
        ...
        const applications = await jobApplicaton.find({userId})
