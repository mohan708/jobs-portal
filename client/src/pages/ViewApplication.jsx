                        ...
                        viewApplicationsPageData.map((applicant,index)=>(
                            <tr className='text-gray-700 border-gray-200 border-b' key={index}>
                                ...
                                <td className='py-2 px-4  text-center flex'>
                                    <img className='w-10 h-10 rounded-ful mr-3 max-sm:hidden' src={applicant.imgSrc} alt="" />
                                ...
                                <td className='py-2 px-4  relative'>
                                    <div className='relative inline-block text-left group'> 
                                        ...
                                        <div className='z-10 hidden absolute right-0 md:left-0 top-0 mt-2 w-32 bg-white border border-gray-200 rounded shadow group-hover:block'>
                                            ...
                                            <button  className='block w-full text-left px-4 py-2 text-500 hover:bg-gray-100'>Reject</button>
                                        </div>
                                    </div>
                                </td>
                            </tr>
